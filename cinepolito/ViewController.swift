...
extension ViewController: UICollectionViewDataSource  {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {//dibuja las celdas
        ...
        if (collectionView == CollectionView2){
            ...
            cell2.clasificacion.setTitle(movies![indexPath.row].clasificacion!, for: UIControl.State.normal)
            cell2.duracion.text = movies![indexPath.row].duracion
        ...
        cell?.img.kf.setImage( with: URL(string: movies![indexPath.row].url_portada_hero!) )
        return cell!
    }
